...
const canvas = document.querySelector('#three-techman-balance');
...
var strawberryMaterial = new THREE.MeshBasicMaterial({
  map: loader.load('lottie/images/img_1.png'),
  transparent: true,
});

var bananaMaterial = new THREE.MeshBasicMaterial({
  map: loader.load('lottie/images/img_6.png'),
  transparent: true,
});

var grapesMaterial = new THREE.MeshBasicMaterial({
  map: loader.load('lottie/images/img_2.png'),
  transparent: true,
});

const greenMaterialList = [
  strawberryMaterial,
  bananaMaterial,
  grapesMaterial
];
...
var Geometry = new THREE.PlaneGeometry(8, 8/*  *.75  */);

// combine our image geometry and material into a mesh
var sprite1 = new THREE.Mesh(Geometry, todoMaterial);
var sprite2 = new THREE.Mesh(Geometry, todoMaterial);
var sprite3 = new THREE.Mesh(Geometry, todoMaterial);
...
function animate() {
    ...
    if (activeSection == 14 || activeSection == 15) {
      if (Mesh && Mesh.rotation) {

        if (ohmnomSine > .6 && techmanBalanceIsInFlow) {
          ohmnomSine = .61;
        } else {
        ...
        if (ohmnomSine < .2 || techmanBalanceIsInFlow){
          if (todoCounter1 > -.1) {
            todoCounter1 = -3;
            ...
            if (tempRandom > 8) {
              techmanLabelDiv1.className = 'techman-label label-3 font-ibm-plex-mono font-label font-uppercase font-semibold clr-green';
              sprite1.material = greenMaterialList[(tempRandom % 3)];
            } else {
              techmanLabelDiv1.className = 'techman-label label-3 font-ibm-plex-mono font-label font-uppercase font-semibold clr-red';
              sprite1.material = todoMaterial;
            }
          }
          if (todoCounter2 > -.1) {
            todoCounter2 = -3;
            ...
            if (tempRandom > 8) {
              techmanLabelDiv2.className = 'techman-label label-3 font-ibm-plex-mono font-label font-uppercase font-semibold clr-green';
              sprite2.material = greenMaterialList[(tempRandom % 3)];
            } else {
              techmanLabelDiv2.className = 'techman-label label-3 font-ibm-plex-mono font-label font-uppercase font-semibold clr-red';
              sprite2.material = todoMaterial;
            }
          }
          if (todoCounter3 > -.1) {
            todoCounter3 = -3;
            ...
            if (tempRandom > 8) {
              techmanLabelDiv3.className = 'techman-label label-3 font-ibm-plex-mono font-label font-uppercase font-semibold clr-green';
              sprite3.material = greenMaterialList[(tempRandom % 3)];
            } else {
              techmanLabelDiv3.className = 'techman-label label-3 font-ibm-plex-mono font-label font-uppercase font-semibold clr-red';
              sprite3.material = todoMaterial;
            }
          }
        }

        if (todoCounter1 > -1) {
          var tempClasses = techmanLabelDiv1.className + " fade-out";
          techmanLabelDiv1.className = tempClasses;
        }
        if (todoCounter2 > -1) {
          var tempClasses = techmanLabelDiv2.className + " fade-out";
          techmanLabelDiv2.className = tempClasses;
        }
        if (todoCounter3 > -1) {
          var tempClasses = techmanLabelDiv3.className + " fade-out";
          techmanLabelDiv3.className = tempClasses;
        }
...
techmanLabelDiv1.innerHTML = 'Ambiguous specifications&nbsp;';
...
techmanLabelDiv2.innerHTML = 'Team meeting&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
...
techmanLabelDiv3.className = 'techman-label label-3 font-ibm-plex-mono font-label font-uppercase font-semibold clr-red';
techmanLabelDiv3.innerHTML = 'Check email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
...
document.getElementById( 'three-techman-balance-label' ).appendChild(labelRenderer.domElement );
